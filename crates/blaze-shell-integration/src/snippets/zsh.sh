...
# Emits FinalTerm-style block markers AND a Blaze-private command-capture
# sequence so Blaze can copy/rerun the exact command without scraping the
# prompt line. Safe under any prompt theme (uses add-zsh-hook).
